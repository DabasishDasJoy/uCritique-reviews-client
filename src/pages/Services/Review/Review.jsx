...
const Review = ({
  review: { dateAdded, imgUrl, ratings, author_name, review },
}) => {
  return (
    <div className="container flex flex-col w-full p-6 mx-auto divide-y rounded-md divide-gray-700  text-textPrimary">
