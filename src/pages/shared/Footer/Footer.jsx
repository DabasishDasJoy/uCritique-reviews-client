...
import logo from "../../../assets/dentalcare-logo-white.png";

const Footer = () => {
  return (
    <footer className="px-4 divide-y bg-[#004365] text-gray-100 mt-10">
      ...
      <div className="py-6 text-sm text-center text-gray-400">
        © 2022 Dabasish Das Joy. All rights reserved.
      </div>
    </footer>
  );
};
